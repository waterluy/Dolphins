...
def pgd_attack(model, vision_x, input_ids, attention_mask, labels=None, epsilon=0.001, steps=10, lp='linf', dire='pos',key_mode='normal'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--key_mode', type=str, default='normal')
    ...
    with open(json_file, 'w') as file:
        ...
        for entry in tqdm(data):
            ...
            # pgd attack
            noise = pgd_attack(model=model, vision_x=images, input_ids=input_ids, attention_mask=attention_mask, labels=labels, epsilon=args.eps, steps=args.steps, lp=args.lp, dire=args.dire, key_mode=args.key_mode)
