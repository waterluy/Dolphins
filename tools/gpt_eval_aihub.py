...
class GPTEvaluationAihub:
    ...
    def call_chatgpt(self, chatgpt_messages, max_tokens=77):    # gpt-3.5-turbo-0613 gpt-4o-all
        response = self.client.chat.completions.create(
            model=self.gpt_model, messages=chatgpt_messages, temperature=0.6, max_tokens=max_tokens
        )
        # print(response)
    ...
    def GPT_eval(self, answer, GT):
        prompts = "Rate my answer based on the correct answer out of 100, with higher scores indicating that the answer is closer to the correct answer, and you should be accurate to single digits like 77, 93, 56,etc. Output the number only. "
...
if __name__ == "__main__":
    ...
    save_path = args.json_path.replace(".json", "_gpt4o.txt")
