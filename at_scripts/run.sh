...
# bash at_scripts/sat.sh
# bash at_scripts/adapterRes_tuning.sh ok
bash at_scripts/adapterRes_both_key_entropy_atten.sh
bash at_scripts/sat.sh
bash at_scripts/adapterRes_key_entropy_atten.sh
bash at_scripts/adapterRes4visual.sh

# todo
# bash at_scripts/sat_both_key_entropy_atten.sh
# bash at_scripts/sat_key_entropy_atten.sh
# bahs at_scripts/visualat_both.sh
